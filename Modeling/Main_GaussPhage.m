...
parfor ii = 1:length(cell2I)
    for jj = 1:length(cell2Chi)    
        ...
        SimParams.OutFolderName = './Outputs_GaussPhage/OutputsIChi_GaussPhage/';
...
parfor ii = 1:length(cell2I)
    for jj = 1:length(cell2cA)    
        ...
        SimParams.OutFolderName = './Outputs_GaussPhage/OutputsIcA_GaussPhage/';
...
parfor ii = 1:length(cell2I)
    for jj = 1:length(cell2cR)    
        ...
        SimParams.OutFolderName = './Outputs_GaussPhage/OutputsIcR_GaussPhage/';
