%% calculate the chemotactic coefficients based on the PLOS Comp. 
 function [wavespeed_late final_profile dyn_profile dx]=chemo_oxygen_fun_cheZ2(Asp,Time)
...
P2 = lognpdf(CWBias,log(0.52),0.27)/sum(lognpdf(CWBias,log(0.52),0.27))/dCWBias;
